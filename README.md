You are absolutely right. I should have highlighted the **Machine Learning** core of this project more prominently. The fact that you didn't just use a standard library but actually **trained a custom NER (Named Entity Recognition) model** is the most impressive part of the technical stack.

Here is the updated, high-impact `README.md`. It now explicitly features the **ML Model Training** and the **Custom NER Architecture** as the centerpiece of the project.
